	...
	public void run() {
		...
		while (getVentanaArkanoid().getCuadrados().size() > 0) {
			...
			try {
				...
				if (getPosicionY() < 73 || (getPosicionY() + getDimension()) > getVentanaArkanoid().getHeight()) {
				...
				getVentanaArkanoid().getCuadrados().forEach(c -> {
					if (miraChoque(c)) {
						...
						if (miRectangulo.intersectsLine((int) (c.getPosicionX() + this.getDimension()),
								(int) (c.getPosicionY()), (int) (c.getPosicionX() + c.getAncho() + this.getDimension()),
								(int) (c.getPosicionY()))
								|| miRectangulo.intersectsLine((int) (c.getPosicionX() + this.getDimension()),
										(int) (c.getPosicionY() + c.getAlto()),
										(int) (c.getPosicionX() + c.getAncho() + this.getDimension()),
										(int) (c.getPosicionY() + c.getAlto()))) {
